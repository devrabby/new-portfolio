...
const About = ({ isDark, setisDark }) => {
    return (
        <motion.div
            ...
            className='w-full  px-[12%] py-10 scroll-my-20' id='about-me'>
            ...
            <motion.div
                ...
                <motion.div
                    ...
                    className='w-64 max-w-none sm:w-80 rounded-3xl'>
                ...
                <motion.div
                    ...
                    className='flex-1 '>
                    <p className='mb-10 max-w-2xl'>I'm a passionate Front-End developer with a strong intrest in building clean, responsive, and user-friendly web applications.
                            ...
                            My long term goal is to become a well-rounded front-end engineer capable of delivering impactful solutions for businesses and making the technology easier to use.</p>
                    ...
                    <motion.ul
                        ...
                        {infoList.map(({ icon, iconDark, title, description }, index) => (
                            <motion.li
                                ...
                                key={index} className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-[#fcf4ff] hover:-translate-y-1 duration-500 hover:shadow-2xl dark:border-white dark:hover:shadow-white dark:hover:bg-[#11001F]'>
                    ...
                    <motion.ul
                        ...
                        {toolsData.map((tool, index) => (
                            <motion.li
                                ...
                                key={index} className='flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:bg-[#fcf4ff] hover:-translate-y-1 duration-500 hover:shadow-2xl'>
